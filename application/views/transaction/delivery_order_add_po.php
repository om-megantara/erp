          ...
          <div class="modal-body">
            <table>
	        	<tr class="cellproduct" dataproduct="">
                    ...
                    <input class="form-control input-sm totaldor" name="totaldor[]" type="text" readonly="" required="">
                  </td>
                  ...
                  <td><input class="form-control input-sm productstock" name="productstock[]" type="number" required="" readonly=""></td>
	                ...
	                <td><input class="form-control input-sm productqtysent" name="productqtysent[]" type="number" min="1" required="" readonly=""></td>
...
if (product !== null) {
      ...
      $(".cellproduct:first .totaldor").val("DOR : "+product[i]['totaldor']);
