...
<div class="content">
	<table width="750px">
		<tr class="header-company">
			<td colspan="4">
				...
				<a href="#" id="showContent" class="showContent" autofocus>Show FC</a>
	...
	<table width="750px;" class="sign">
		...
		<tr>
			...
			<td><?php echo $so['salesname'];?><br>(Sales)</td>
			<td><?php echo $so['secname'];?><br>(SEC)</td>
			<td><?php echo $so['admin'];?><br>(Admin)</td>
		</tr>
	</table>
