...
<div class="content-wrapper">
  ...
  <section class="content">
          ...
          <div class="modal-body">
            <div class="formCP">
              ...
              <div class="form-group">
                ...
                <span class="left2">
                  <input type="text" class="form-control input-sm pull-right" id="invmp" name="invmp" autocomplete="off" required="">
                </span>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <span class="left2">
                  <input type="text" class="form-control input-sm pull-right" id="resi" name="resi" autocomplete="off" required="">
                </span>
              </div>
              <div class="form-group">
            ...
            <table>
              <tr class="cellproduct" dataproduct="">
                ...
                <td>
                  ...
                  <input class="form-control input-sm PV2 mask-number" name="PV2[]" type="number" style="text-align: right;" readonly="" required="">
                </td>
                <td>
    ...
    <div class="box box-solid">
      <div class="box-body">
          <form name="form" id="form" action="<?php echo base_url();?>transaction/sales_order_offline_add_act" method="post" enctype="multipart/form-data" autocomplete="off">
            <div class="col-md-6">
              <div class="box box-solid detailcustomer">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group vcenter">
                      ...
                      <span class="left2">
                          <select class="form-control input-sm address" name="address" required=""></select>
              ...
              <div class="box box-normal box-solid detailso">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group ">
                      ...
                      <span class="left2">
                        <input type="text" class="form-control input-sm pull-right" id="pono" name="pono" autocomplete="off">
                      </span>
                    </div>
                    <div class="form-group col-md-12 vcenter">
                      ...
                      <div class="form-group col-md-3">
                        <select class="form-control input-sm socategory" name="socategory" required="">
                          <option value="7">Sales Offline</option>
                          <option value="6">Sample</option>
                          <?php if (in_array("sales_order_admin", $MenuList)) {?>
                            <option value="3">Replacement</option>
                          <?php } ?>
                        </select>
                      </div>
                      <div class="col-md-3"><label>SO Min DP %</label></div>
                      <div class="form-group col-md-3"><input type="number" minlength="1" class="form-control input-sm minimumdp" name="minimumdp" required="" min="0" value="0"></div>
                    </div>
                    <div class="form-group col-md-12 vcenter">
                    ...
                    <div class="form-group col-md-12 vcenter">
                      ...
                      <div class="col-md-3"><label>Ship Days</label></div>
                      <div class="form-group col-md-3">
                          <input type="number" minlength="1" class="form-control input-sm shipdays" name="shipdays" required="" min="0">
                      </div>
                    </div>
                    <div class="form-group col-md-12 vcenter">
                      ...
                      <div class="form-group col-md-3"><input type="number" minlength="1" class="form-control input-sm sopaymentterm" name="sopaymentterm" required="" min="0"></div>
                    </div>
                    <div class="form-group col-md-12 vcenter">
                      <label class="left" style="margin-left:-5px">SO Note</label>
                      <span class="left2">
                        <textarea class="form-control input-sm pull-left note" name="note" autocomplete="off" ></textarea>
                      </span>
                    </div>
...
j8('.customer').on("select2:select", function(e) { 
  ...
  j8.ajax({
    url: "<?php echo base_url();?>transaction/get_customer_address_pv",
    type : 'GET',
...
function fillproduct(response) {
  if (j8.inArray(response['ProductID'], curlist) < 0) {  //cek jika product exist in list
    ...
    j8(".cellproduct:first .SEPVMp").val(response['SEPVMultiplier']);
    ...
    j8(".cellproduct:first .ProductPriceDefault2").text(parseFloat(response['ProductPriceDefault2']).toLocaleString("id-ID")).attr('title', response['PricelistName']);
