				...
				<tr class="header-po1">
					<td>
						<table>
							...
							<tr>
								<td width="75px">Mutation</td>
								<td class="detail"><?php echo $do['DOReff']; ?></td>
							</tr>
						</table>
					</td>
					<td>
						<table>
							<tr><td width="100px"></td><td class="detail">0</td></tr>
							<tr><td width="100px"></td><td class="detail">0</td></tr>
							<tr><td width="100px"></td><td class="detail">0</td></tr>
						...
						<table>
							<tr>
								<td class="detail" style="width: 350px; padding: 5px;">
									<br><br><?php echo $warehouse1['WarehouseName']."<br>".$warehouse1['WarehouseAddress']."<br>".$warehouse1['WarehousePhone']; ?>
								</td>
								<td class="detail" style="width: 350px; padding: 5px;">
									<br><br><?php echo $warehouse2['WarehouseName']."<br>".$warehouse2['WarehouseAddress']."<br>".$warehouse2['WarehousePhone']; ?>
								</td>
							</tr>
						</table>
					</td>
						            ...
						            if (isset($content['product'])) {
						                foreach ($content['product'] as $row => $list) { ?>
							                <tr>
							                    ...
							                    <td class="productName" style="width: 300px;"><?php echo $list['ProductCode'];?></td>
							                    <td class="QtyRequested"></td>
							                    <td class="QtySent"></td>
							                    <td class="QtySend"><?php echo $list['ProductQty'];?></td>
							                    <td class="QtySend"></td>
