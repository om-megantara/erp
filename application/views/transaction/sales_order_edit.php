              ...
              <div class="box box-normal box-solid detailso">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group col-md-12 vcenter DueDateProduct">
                      ...
                      <div class="form-group">
                        <label class="left" style="margin-left:-5px">Note</label>
                        <span class="left2">
                    ...
                    <div class="form-group col-md-12 vcenter">
                      <label class="left" style="margin-left:-5px">Expedition</label>
                      <span class="left2">
                    ...
                    <div class="form-group col-md-12 vcenter">
                      <label class="left" style="margin-left:-5px">SO Term</label>
                      <span class="left2">
                    ...
                    <div class="form-group searchcp">
                      ...
                      <div class="input-group left2">
                        <span class="input-group-btn" >
                          ...
                          <input type="hidden" class="invmp2" id="invmp2" name="invmp2" value="<?php echo $content['so']['INVMP']; ?>">
                          <input type="hidden" class="resi2" id="resi2" name="resi2" value="<?php echo $content['so']['ResiNo']; ?>">
                          <input type="hidden" class="label2" id="label2" name="label2" value="<?php echo $content['so']['Label']; ?>">
                        </span>
                      </div>
                    </div>
                    <?php } ?>
