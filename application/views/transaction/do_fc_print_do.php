<?php
$domain 	= (array) $content['domain'];
$dodetail 	= (array) $content['dodetail'];
...
<head>
	...
	<style type="text/css">
		...
		.header-po1>td:first-child { width: 400px; }
	...
	<div class="content">
		...
		<table width="750px">
			<tr class="header-po1">
				<td>
					<table>
						<tr><td width="100px">DO No </td><td>:</td><td class="detail"><?php echo $domain['DOID']; ?></td></tr>
						<tr><td width="100px">Mutation No </td><td>:</td><td class="detail"><?php echo $domain['MutationID']; ?></td></tr>
						<tr><td width="100px">Mutation Date </td><td>:</td><td class="detail"><?php echo $domain['MutationDate']; ?></td></tr>
					</table>
				</td>
				<td>
					<table>
						<tr><td width="100px">Warehouse From</td><td>:</td><td class="detail"><?php echo $domain['WarehouseFrom']; ?></td></tr>
						<tr><td width="100px">Warehouse To</td><td>:</td><td class="detail"><?php echo $domain['WarehouseTo']; ?></td></tr>
						<tr><td width="100px">Employee Name</td><td>:</td><td class="detail"><?php echo $domain['fullname']; ?></td></tr>
					</table>
				</td>
			</tr>
		</table><br>
		<table width="750px;" class="productlist">
			...
			<tbody>
				<?php
		            if (isset($content['dodetail'])) {
		                foreach ($dodetail as $row => $list) { 
		                	$qtyTotal += $list['ProductQty'];
		                	$weight = $list['ProductQty']*$list['Weight']; 
		                	$weightTotal += $weight;

		        ?>
			                <tr>
			                    <td class="ProductCode"><div class="ProductID">(<?php echo $list['ProductID'];?>)</div> <?php echo $list['ProductName'];?></td>
			                    <td class="qtyreceive"><?php echo $list['Weight'];?></td>
			    ...
			    <tr>
			    	...
			    	<td class="producttotal" colspan="2"><?php echo number_format($domain['MutationFC']); ?></td>
			    </tr>
			</tbody>
		</table><br>
