              ...
              <div class="box box-normal box-solid detailso">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group ">
                      ...
                      <span class="left2">
                        <select class="form-control input-sm dropdownscroll" id="demo-desktop" data-input-style="box" name="projectid" required="">
                          <option value="0">Non Project</option>
                          <?php foreach ($project as $row => $list) { ?>
                              <option value="<?php echo $list['ProjectID']; ?>"><?php echo $list['ProjectID']." (".$list['Company2'].")"; ?></option>
                          <?php } ?>
                        </select>
                      </span>
                    </div>
                    <div class="form-group col-md-12 vcenter">
                      ...
                      <div class="form-group col-md-3">
                        <select class="form-control input-sm invcategory" name="invcategory" required="">
                          <option value="1">Normal, DO to Invoice</option>
                          <option value="2">Percent, SO to Invoice</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group col-md-12 vcenter">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <!-- <select class="form-control input-sm sotype" name="sotype" required="" onmousedown="(function(e){ e.preventDefault(); })(event, this)"> -->
                    ...
                    <div class="form-group col-md-12 vcenter DueDateProduct">
                      <div>
                        <label>Due Date 'Product Ready'</label>
                      </div>
                      <div class="checkbox_dd">
                        <label>
                          <input type="checkbox" class="DueDate" name="DueDate1" value="1">
                          Due Date Purchasing
                        </label>
                      </div>
                      <div class="checkbox_dd">
                        <label>
                          <input type="checkbox" class="DueDate" name="DueDate2" value="1">
                          Due Date Service
                        </label>
                      </div>
                      <div class="form-group">
                        ...
                        <span class="left2">
                          <textarea class="form-control input-sm DueDateNote" name="DueDateNote" autocomplete="off"></textarea>
                        </span>
                      </div>
                    </div>
                    <div class="form-group col-md-12 vcenter">
                    ...
                    <div class="form-group col-md-12 vcenter">
                      <label class="left">SO Term</label>
                      <span class="left2">
                        <textarea class="form-control input-sm term" name="term" autocomplete="off"></textarea>
                      </span>
                    </div>
                    <div class="form-group col-md-12 vcenter">
                      <label class="left">SO Note</label>
                      <span class="left2">
