					...
					<th colspan="8">
						<table width="750px">
							<tr class="header-company">
								<td colspan="2"><img src="<?php echo base_url();?>tool/kopsg.png" width="300px" align="left" style="vertical-align:top; margin-bottom: 0px;" ></td>
								<td colspan="2">							
									<h3 style="margin-bottom: 0px; margin-top: 10px;" align="right">SALES ORDER. <?php echo $so['SOID']; ?></h3>
								</td>
							</tr>
							<tr >
								<td colspan="4">
							...
							<tr class="header-po1">
								<td>
									<table>
										...
										<tr><td width="75px">SO Category </td><td>:</td><td class="detail"><?php 
											if ($so['SOType']=='standard'){
												$SOType="S";
											}elseif ($so['SOType']=='custom'){
												$SOType="C";
											}else {
												$SOType="P";
											}
										echo $so['CategoryName'].' ('.$SOType.')'; ?></td></tr>
			...
			<tbody width="750px;" class="productlist">
			        ...
			        ?>
		                <tr class="content1">
		                    ...
		                    <td class="right"><?php echo number_format($list['PVSO'],2);?></td>
