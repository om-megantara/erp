...
<div class="content">
	...
	<table width="750px">
		...
		<tr style="text-align: center;"><td colspan="3">Nomor : <?php echo $FakturParent.$main['INVRNote']; ?></td></tr>
		<tr><td colspan="3">Kode dan Nomer Seri Faktur Pajak Retur : <?php echo $FakturParent.$main['FakturNumber']; ?>, Tanggal : <?php echo $FakturParent.$main['INVDate']; ?></td></tr>
		...
		<tr>
			...
			<td style="text-align: right;"><?php echo number_format($TaxFinal,2);?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="text-align: right;"><?php echo number_format($main['PriceTax']+$main['FCTax'],2);?></td>
		</tr>
		<tr>
			<td colspan="3" style="padding-left: 500px;">
				<br><br>
				Surabaya, <?php echo date("d M Y", strtotime($main['INVRDate'])) ; ?>
				<br><br><br>
				Finance
				<br><br>
			</td>
