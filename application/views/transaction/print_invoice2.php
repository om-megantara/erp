...
<head>
	...
	<style type="text/css">
		...
		.productlist thead th { font-size: 14px; padding-bottom: 20px;}
	...
	<a href="#" class="btn-header ShowContentNonPromo" autofocus>Non Promo</a>
		...
		<div class="page-header">
			<table width="750px">
				...
				<tr class="header-po1" style="height: 80px;">
					...
					<td colspan="2" width="245px">
						<table>
							...
							<tr><td width="100px">Delivery Order</td><td>:</td><td class="detail">
								<?php if (isset($main['DODate'])) { ?>
								<?php echo "[".$main['DOID']."] ".$main['DODate']; ?>
								<?php } ?>
								</td></tr>
				...
				<tr class="header-po1" style="height: 90px;">
		...
		<tbody>
			<tr>
				<td>
					<table width="750px" height="350px" class="productlist" style="margin-top: 10px; margin-left: 0px;">
						<thead>
							<tr>
								<th colspan="6"><br></th>
							</tr>
						...
						<tfoot>
							<tr><td colspan="6" style="height: 130px">.</td></tr>
						</tfoot>
					</table>
				</td>
			</tr>
