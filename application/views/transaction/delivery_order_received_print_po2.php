...
<head>
	...
	<style type="text/css">
		...
		.titletotal { text-align: right; font-weight: bold; }
		...
		<tbody>
			<?php
	            ...
	            if (isset($content['product'])) {
	                foreach ($Product as $row => $list) { 
	                	$linetotal = $list['ProductPrice'] * $list['qtyreceive'];
						$total += $linetotal;
	        ...
	        ?>
		                <tr>
		                    ...
		                    <td class="linetotal"><?php echo number_format($list['ProductPrice']);?></td>
		                    ...
		                    <td class="linetotal"><?php echo number_format( $linetotal );?></td>
		                </tr>
		    <?php	
					} 
		    	} 
		    ?>
    				...
    				<tr>
	                    <td class="titletotal" colspan="5"> Sub Total </td>
	                    <td class="linetotal"><?php echo number_format( $total );?></td>
	                </tr>
	                <tr>
	                    <td class="titletotal" colspan="5"> tax </td>
	                    <td class="linetotal"><?php echo number_format( $total*($dor['TaxRate']/100) );?></td>
	                </tr>
	                <tr>
	                    <td class="titletotal" colspan="5"> Grand Total </td>
	                    <td class="linetotal"><?php echo number_format( $total + ($total*($dor['TaxRate']/100)) );?></td>
	                </tr>
		</tbody>
	</table><br>
