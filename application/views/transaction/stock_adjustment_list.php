  ...
  <section class="content">
    ...
    <div class="box box-solid">
      <div class="box-header">
        ...
        <a href="<?php echo base_url();?>transaction/stock_adjustment_add" class="btn btn-primary btn-xs addadjustment">Add Stock Adjusment</a>
        <a href="<?php echo base_url();?>transaction/stock_adjustment_add_non_opname" class="btn btn-primary btn-xs addadjustment">Add Stock Adjusment non Opname</a>
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          ...
          <?php
            ...
            if (isset($content)) {
                ...
                <tr>
                  <td><?php echo $list['AdjustmentID'];?></td>
                  <td><?php echo $list['OpnameID'];?></td>
                  <td><?php echo $list['AdjustmentDate'];?></td>
                  <td><?php echo $list['fullname'];?></td>
                  <td><?php echo $list['AdjustmentNote'];?></td>
                  <td>
                    <button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" id="<?php echo $list['AdjustmentID']; ?>" data-toggle="modal" data-target="#modal-note"><i class="fa fa-fw fa-search"></i></button>

                    <?php if ($list['ApprovalID']=="") { ?>
                    <?php if ($list['OpnameID']!="0") { ?>
                    <button type="button" class="btn btn-success btn-xs" title="EDIT" onclick="window.open('<?php echo base_url();?>transaction/stock_adjustment_add?id=<?php echo $list['AdjustmentID']; ?>', '_blank');"><i class="fa fa-fw fa-edit"></i></button>
                    <?php } else { ?>
                    <button type="button" class="btn btn-success btn-xs" title="EDIT" onclick="window.open('<?php echo base_url();?>transaction/stock_adjustment_add_non_opname?id=<?php echo $list['AdjustmentID']; ?>', '_blank');"><i class="fa fa-fw fa-edit"></i></button>
                    <?php } ?>
                    <button type="button" class="btn btn-success btn-xs approval" title="Approval Submit" AdjustmentID="<?php echo $list['AdjustmentID']; ?>"><i class="fa fa-fw fa-share-square-o"></i></button>
                    <button type="button" class="btn btn-danger btn-xs cancel" title="CANCEL" AdjustmentID="<?php echo $list['AdjustmentID']; ?>"><i class="fa fa-fw fa-trash-o"></i></button>
                    <?php } ?>
...
jQuery( document ).ready(function( $ ) {
  ...
  $('.approval').live('click',function(e){
    var
      AdjustmentID = $(this).attr('AdjustmentID');
  ...
  function get(id) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>transaction/stock_adjustment_detail"
      url=url+"?id="+id
      // alert(url);
