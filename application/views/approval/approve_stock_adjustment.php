      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Stock Adjustment Detail</h4>
            </div>
            ...
            <tbody>
              ...
              ?>
                      <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-success btn-xs detail" title="DETAIL" id="<?php echo $list['ApprovalID'];?>" adjustment="<?php echo $list['AdjustmentID'];?>" data-toggle="modal" data-target="#modal-note"><i class="fa fa-fw fa-edit"></i></button>
                        </td>
                      </tr>
              <?php } } ?>
            </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  $('.detail').live('click', function(e){
      id    = $(this).attr("id")
      adjustment  = $(this).attr("adjustment")
      $('.loader').slideDown("fast")
      $('#detailcontent').empty()
      get(adjustment, id);
  });
  function get(adjustment, id) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>approval/approve_stock_adjustment_detail"
      url=url+"?adjustment="+adjustment+"&id="+id
      // alert(url);
