      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Price List Detail</h4>
            </div>
            ...
            <tbody>
              ...
              ?>
                      <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-success btn-xs detail" title="DETAIL" id="<?php echo $list['ApprovalID'];?>" PricelistID="<?php echo $list['PricelistID'];?>" data-toggle="modal" data-target="#modal-note"><i class="fa fa-fw fa-edit"></i></button>
                        </td>
                      </tr>
              <?php } } ?>
            </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  function get(PricelistID, id) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>approval/approve_price_list_detail"
      url=url+"?pricelist="+PricelistID+"&id="+id
      // alert(url);
