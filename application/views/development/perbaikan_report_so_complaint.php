  ...
  <section class="content">
    ...
    <div class="box box-solid">
      <div class="box-header">
        ...
        <div id="divhideshow">
          Hide/Show Column :
          <a class="btn btn-primary btn-xs toggle-vis" data-column="4">So Note</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="5">Ship Address</a>
        </div>
                ...
                <span class="left2">
                  <div class="input-group input-group-sm">
                      <select class="form-control input-sm atributelist" style="width: 100%;" name="atributelist" required="">
                        ...
                        <option value="ProductName">Produc tName</option>
                      </select>
                      <span class="input-group-btn">
          ...
          ?>
                <tr>
                  ...
                  <td>
                    ...
                    <?php if ($EmployeeID==644){?>
                    <button type="button" class="btn btn-success btn-xs" onclick="window.open('<?php echo base_url();?>development/so_complaint_add?CustomerID=<?php echo $list['CustomerID'];?>&SOID=<?php echo $list['SOID'];?>', '_blank');" title='Add Complaint'><i class="fa fa-wechat"></i></button>
                    <?php }?>
...
jQuery( document ).ready(function( $ ) {
  ...
  $(".printso_coba").live('click', function() {
    soid = $(this).attr("soid")
