...
<div class="content-wrapper">
  ...
  <section class="content">
          ...
          <div class="modal-body">
            <table>
                ...
                <td>
                  ...
                  <input class="form-control input-sm PricePercent" name="PricePercent[]" type="number" minlength="1" step=".01" required="" title="" readonly="">
                </td>
                <td>
                ...
                <td>
                  ...
                  <input class="form-control input-sm PriceAmount mask-number" name="PriceAmount[]" type="text" minlength="1" required="" step="1" readonly="">
                </td>
                <td>
    ...
    <div class="box box-solid">
      <div class="box-body">
          <form name="form" id="form" action="<?php echo base_url();?>development/perbaikan_sales_order_add_act" method="post" enctype="multipart/form-data" autocomplete="off">
            <div class="col-md-6">
...
j8('.customer').select2({
  ...
  ajax: {
    url: '<?php echo base_url();?>development/search_customer_city_sales',
    dataType: 'json',
    delay: 1000,
...
j8('.customer').on("select2:select", function(e) { 
  ...
  j8.ajax({
    url: "<?php echo base_url();?>development/get_customer_address",
    type : 'GET',
...
function fillproduct(response) {
  if (j8.inArray(response['ProductID'], curlist) < 0) {  //cek jika product exist in list
    ...
    j8(".cellproduct:first .PV").text(response['PV']);
...
function openPopupOneAtATime() {
    if (popup && !popup.closed) {
       ...
       popup = window.open('<?php echo base_url();?>development/product_list_popup_so_offline', '_blank', 'width=700,height=500,left=200,top=100');     
    }
}
function ProcessChildMessage(message) {
  ...
  if (message['forsale']==1) {
    j8.ajax({
      url: "<?php echo base_url();?>development/get_product_price",
      type : 'POST',
...
j8(".checkPrice").live('click', function() {
  ...
  paymentmethod  = j8(".paymentmethod").val()
  j8.ajax({
    url: "<?php echo base_url();?>development/get_product_promo",
    type : 'POST',
