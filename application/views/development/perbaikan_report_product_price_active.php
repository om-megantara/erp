        ...
        <div class="divfilterdate">
          <form role="form" action="<?php echo current_url();?>" method="post" >
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label class="left">Source Of Origin</label>
                <span class="left2">
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">PV TOP</th>
              <th class=" alignCenter">PV CBD</th>
            </tr>
          </thead>
          <tbody>
          <?php
            ...
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td class="alignleft"><a class="view_detail" type="button" product="<?php echo $list['ProductID'];?>" data-toggle="modal" data-target="#modal-detail"><?php echo wordwrap($list['ProductName'],55,"<br>\n");?></a></td>
                  <td class="alignleft"><?php echo wordwrap($list['ProductCategoryName'],25,"<br>\n");?></td>
                  <td class="alignleft"><?php echo $list['StateName'];?></td>
                  <td class="alignCenter"><?php echo number_format($list['Stock'],0);?></td>
                  <!-- <td class="alignCenter"><?php echo number_format($list['PT1Discount'],0)." %";?></td>
                  <td class="alignCenter"><?php echo number_format($list['PT2Discount'],0)." %";?></td> -->
                  <td class=" alignCenter"><?php echo number_format($list['Price'],0);?></td>
                  <!-- <td class=" alignCenter"><?php echo number_format($list['Price'],0)." %";?></td> -->
                  <td class=" alignCenter"><?php echo number_format($list['TOP'],0);?></td>
                  <td class="alignRight"><?php echo number_format($list['CBD'],0);?></td>
                  <?php if ($list['PVTOP']>0){ ?> 
                  <td class="alignRight"><?php echo number_format($list['PVTOP'],2);?></td>
                  <?php } else { ?><td class="alignRight">0.00</td>
                  <?php } ?>
                  <?php if ($list['PVCBD']>0){ ?> 
                  <td class="alignRight"><?php echo number_format($list['PVCBD'],2);?></td>
                   <?php } else { ?><td class="alignRight">0.00</td>
                  <?php } ?>
                </tr>
          <?php } } ?>
