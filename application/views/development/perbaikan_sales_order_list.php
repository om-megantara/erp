  ...
  <section class="content">
    ...
    <div class="box box-solid">
      <div class="box-header">
        <a title="ADD SALES ORDER" href="<?php echo base_url();?>development/perbaikan_sales_order_add" id="add_sales_order" class="btn btn-primary btn-xs add_sales_order"><b>+</b> Add Sales Order</a>
            ...
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" class="btn btn-primary btn-xs attachFile" title="ATTACH FILE" soid="<?php echo $list['SOID']; ?>" data-toggle="modal" data-target="#modal-file"><i class="fa fa-fw fa-list-ol"></i></button>
