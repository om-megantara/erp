...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-solid">
      <div class="box-body">
        <form name="form" id="form" action="<?php echo base_url();?>development/so_complaint_add_act" method="post" enctype="multipart/form-data" autocomplete="off">
          <div class="col-md-6">
            <div class="form-group">
              <label class="left">Code</label>
              <label class="left2" name="code"> 
                <?php $no=$content['no']; $nourut=$no+1; $bulan=date("m"); $tahun=date("y"); echo $COmplaintID="C.".str_pad($nourut, 4,"0",STR_PAD_LEFT).".".$bulan.".".$tahun;?></label>
