    ...
    <div class="box box-solid">
      <div class="box-body">
        ...
        <div id="divhideshow" style="border: 1px solid #0073b7; padding: 5px;">
            ...
            <button class="toggle-vis btn btn-primary btn-xs" data-column="4">Shop Assigned</button>
            <button class="toggle-vis btn btn-primary btn-xs" data-column="5">Link Updated</button>
            <button class="toggle-vis btn btn-primary btn-xs" data-column="6">Status</button>
        </div>
        <div id="divsearch">
        ...
        <table id="dt_list" class="table table-bordered table-hover nowrap" width="100%">
          <thead>
            <tr>
              ...
              <th class="alignCenter">Shop Assigned</th>
              <th class="alignCenter">Link Updated</th>
...
j11( document ).ready(function( $ ) {
  ...
  .DataTable({
    ...
    "serverSide": true, 
    "ajax": {
      "url": "<?php echo site_url('development/report_product_shop_data')?>",
      "type": "POST",
      beforeSend: function(){
...
function get2(productid){
  xmlHttp=GetXmlHttpObject()
    var url="<?php echo base_url();?>development/product_shop_detail"
