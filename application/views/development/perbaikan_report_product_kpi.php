          ...
          <form role="form" action="<?php echo current_url();?>" method="post" >
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <span class="left2">
                  <select class="form-control input-sm select2" style="width: 100%;" name="origin" id="origin">
        ...
        <table id="dt_list" class="table table-bordered " style="width: 90% !important;">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">QTYSold<br>SO (INV)</th>
              ...
              <th class=" alignCenter">DStok<br>Left</th>
            </tr>
          </thead>
          <tbody>
          <?php
            ...
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td class="alignleft"><a class="view_detail" type="button" product="<?php echo $list['ProductID'];?>" data-toggle="modal" data-target="#modal-detail"><?php echo wordwrap($list['ProductName'],18,"<br>\n");?></a></td>
                  <td class="alignleft"><?php echo wordwrap($list['ProductCategoryName'],5,"<br>\n");?></td>
                  <td class="alignleft"><?php echo wordwrap($list['Origin'],5,"<br>\n");?></td>
                  <td class="alignCenter"><?php echo number_format($list['Stok'],0);?></td>
                  <td class=" alignCenter"><?php echo number_format($list['QTYSold2'],0)." (".number_format($list['QTYSold'],0).")";?></td>
                  ...
                  <td class=" alignCenter"><?php echo number_format($list['top'],2);?></td>
