          ...
          <table id="dt_list" class="table table-bordered table-hover nowrap" width="100%">
            ...
            ?>
                  <tr>
                    ...
                    <td><a href="../approval/approve_marketing_activity"><?php echo "Total CFU Pending = ".$list['CFUNotApprove'];?></a><br><a href="../approval/approve_marketing_activity"><?php echo "Total CV Pending = ".$list['CVNotApprove'];?></a></td>
