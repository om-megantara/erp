          ...
          // die();
            if (isset($content)) {
                ...
                <tr>
                  ...
                  <td class="alignLeft"><?php echo $list['salesname'];?></td>
                  <td class="alignRight"><?php echo $list['TotalCustomer'];?></td>
                  <td>
                    <button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" id="<?php echo $list['SalesID']; ?>" datestart="<?php echo $list['filterstart']; ?>" dateend="<?php echo $list['filterend']; ?>" data-toggle="modal" data-target="#modal-detail" SalesName="<?php echo $list['salesname'];?>"><i class="fa fa-fw fa-search"></i></button>
                  </td>
                </tr>
          <?php } } ?>
          </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  $('.detail').live('click', function(e){
        ...
        current = $(this)
        SalesName = current.attr('SalesName')
        var obj = {type: 'SalesName', id: SalesName};
        localStorage.removeItem('parse_sales_customer');
        localStorage.setItem('parse_sales_customer', JSON.stringify(obj));
        var win = window.open('<?php echo base_url();?>development/perbaikan_report_customer', '_blank');
            win.focus();
  }); 
  ...
  function get(id, datestart, dateend) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>development/perbaikan_report_customer_sales_detail"
