  ...
  <section class="content">
    ...
    <div class="box box-solid">
      <div class="box-header">
        ...
        <a href="#" id="filtermonth" class="btn btn-primary btn-xs filtermonth" title="FILTER"><i class="fa fa-calendar-check-o"></i> Bulan</a>
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          <thead>
            <tr>
              ...
              <th rowspan=2 class=" alignCenter">Total Customer</th>
           ...
           $urut =1;
            if (isset($content)) {
                ...
                <tr>
                  ...
                  <td class="alignRight"><a href="https://www.google.com/maps/search/<?php echo $list['CityName'];?>+toko+bangunan" target="_blank">Link Maps</a></td>
                  <td>
                    <button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" id="<?php echo $list['CityID']; ?>" data-toggle="modal" data-target="#modal-detail" ><i class="fa fa-fw fa-search"></i></button>
                  </td>
                </tr>
          <?php $urut++;} } ?>
          </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  function get(id, datestart, dateend) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>development/perbaikan_report_customer_city_detail"
