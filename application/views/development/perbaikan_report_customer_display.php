          ...
          $urut=1;
            if (isset($content)) {
                ...
                <tr>
                  ...
                  <td class="alignRight">
                    <button type="button" class="btn btn-primary btn-xs detailso" title="CUSTOMER DISPLAY BY CITY" city="<?php echo $list['CityID'];?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button>
                  </td>
                </tr>
          <?php $urut++;} } ?>
          </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  function get(city) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>development/perbaikan_report_customer_display_detail"
      url=url+"?city="+city
