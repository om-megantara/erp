            ...
            <?php
              foreach ($content as $row => $list) { ;?>
                <tr>
                  ...
                  <td class="note"><?php echo $list['ProductDescription'];?></td>
                  <td><?php echo $list['SourceAgent'];?></td>
                  <td><?php echo $list['Shop'];?></td>
                  <td><?php echo $list['ProductManager'];?></td>
                  <td><?php echo $list['StateName'];?></td>
                  <td><?php if($list['FileName']!=''){ ?><a href="<?php echo base_url().'assets/ProductFile/'.$list['FileName'];?>" class="btn btn-flat btn-warning btn-xs" style="margin: 0px;" target="_blank" title="PICTURE"><i class="fa fa-fw fa-image"></i></a><?php } ?></td>
                  <td>
                    <?php if (in_array("koreksi_produk_view_all", $MenuList)) { ?>
                      <a href="<?php echo base_url().'master/product_add?id='.$list['ProductID'];?>" id="edit" class="btn btn-flat btn-primary btn-xs edit view" style="margin: 0px;" target="_blank" title="EDIT"><i class="fa fa-fw fa-edit"></i></a>
                    <?php } ?>
                  </td>
                </tr>
            <?php } ?>
