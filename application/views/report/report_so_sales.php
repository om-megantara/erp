        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">Total CT</th>
          ...
          <?php
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td class="alignRight"><?php echo $list['SOTotal'];?></td>
                  <td class="alignRight"><?php echo $list['CTTotal'];?></td>
                  <td class="alignRight"><?php echo $list['TotalOutstanding'];?></td>
                  <td>
                    <button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" id="<?php echo $list['SalesID']; ?>" datestart="<?php echo $list['filterstart']; ?>" dateend="<?php echo $list['filterend']; ?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button>
                    <button type="button" class="btn btn-success btn-xs detailmonth" title="DETAIL BY MONTH" id="<?php echo $list['SalesID']; ?>" datestart="<?php echo $list['filterstart']; ?>" dateend="<?php echo $list['filterend']; ?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button>
                  </td>
                </tr>
          <?php } } ?>
          </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  function get(id, datestart, dateend) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>report/report_so_sales_detail"
  ...
  function get2(id, datestart, dateend) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>report/report_so_sales_detail_month"
      url=url+"?id="+id+"&datestart="+datestart+"&dateend="+dateend
      // alert(url);
      xmlHttp.onreadystatechange=stateChanged
      xmlHttp.open("GET",url,true)
