    ...
    <div class="box box-solid">
      <div class="box-header">
          ...
          <div class="divfilterdate">
            <form role="form" action="<?php echo base_url();?>report/report_inv_customer" method="post" >
              <div class="col-md-6">
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">INV Confirmed</th>
          ...
          <?php
            ...
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <!-- <td class="alignRight"><a class="detail" title="DETAIL" id="<?php echo $list['CustomerID']; ?>" datestart="<?php echo $list['INVDateStart']; ?>" dateend="<?php echo $list['INVDateEnd']; ?>" data-toggle="modal" data-target="#modal-detail"><?php echo number_format($list['confirmed'],2);?></a></td> -->
                  <td class="alignRight"><?php echo number_format($list['confirmed'],2);?></td>
                  <td class="alignRight"><?php echo number_format($list['INVConfirmed'],0);?></td>
