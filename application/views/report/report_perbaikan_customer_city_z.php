           ...
           $urut =1;
            if (isset($content)) {
                ...
                <tr>
                  ...
                  <td class="alignLeft"><?php echo $list['City'];?></td>
                  ...
                  <td>
                    <button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" id="<?php echo $list['CityID']; ?>" datestart="<?php echo $list['filterstart']; ?>" dateend="<?php echo $list['filterend']; ?>" data-toggle="modal" data-target="#modal-detail" ><i class="fa fa-fw fa-search"></i></button>
                  </td>
                </tr>
          <?php $urut++;} } ?>
          </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  function get(id, datestart, dateend) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>report/report_perbaikan_customer_city_detail_z"
