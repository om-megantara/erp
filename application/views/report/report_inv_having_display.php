          ...
          <?php
            ...
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td class="alignRight"><?php echo number_format($list['completed']+$list['confirmed'],3);?></td>
                  <td>
                    ...
                    <button type="button" class="btn btn-warning btn-xs detaildisplay" title="DETAIL DISPLAY" id="<?php echo $list['CustomerID']; ?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button>
                  </td>
                </tr>
          <?php } } ?>
          </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  $('.detaildisplay').live('click', function(e){
        id  = $(this).attr("id")
        get3(id);
  }); 
  ...
  function get3(id) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>report/report_so_display_detail_by_customer"
      url=url+"?id="+id
      document.getElementById("detailcontent").innerHTML='<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span>'
      // alert(url);
      xmlHttp.onreadystatechange=stateChanged
