        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          <thead>
            <tr>
              ...
              <th class="alignCenter">Product NonTax</th>
          ...
          <?php
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td class="alignleft"><?php echo $list['ShopName'];?></td>
                  <td class="alignleft"><?php echo $list['INVNote'];?></td>
                  <td class="alignleft"><?php echo $list['due_date']." / ".$list['datediff']." days";?></td>
                  <td class="alignRight"><?php echo number_format($list['PriceBeforeTax']+$list['FCInclude'],2);?></td>
                  ...
                  <td>
                      ...
                      <?php } ?>
                        <button type="button" class="btn btn-primary btn-xs printinv" title="PRINT INV" invid="<?php echo $list['INVID'];?>"><i class="fa fa-fw fa-print"></i></button>
...
jQuery( document ).ready(function( $ ) {
  ...
  $(".printinv_coba").live('click', function() {
    invid = $(this).attr("invid")
    openPopupOneAtATime2(invid,"print_invoice_pdf");
  });
