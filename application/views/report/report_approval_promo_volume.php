          ...
          <form role="form" action="<?php echo current_url();?>" method="post" >
              <div class="col-md-6" >
                <div class="form-group">
                  <label class="left">Promo Vol ID</label>
                  <span class="left2">
                    <input type="text" class="form-control input-sm" autocomplete="off" name="promovolid" id="promovolid">
                  </span>
                </div>
              </div>
              <div class="col-md-6">
          ...
          <tbody>
            ...
            ?>
                  <tr>
                      ...
                      <td><?php echo $list['PromoVolID'];?></td>
