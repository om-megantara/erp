          ...
          <?php
            ...
            if (isset($content['main']['main'])) {
                ...
                <tr>
                  ...
                  <td class="alignCenter"><?php echo $list['ProfitPercent'];?> %</td>
                </tr>
          <?php } } ?>
          </tbody>
          <tfoot>
  ...
  var table = $('#dt_list').DataTable({
    ...
    "footerCallback": function ( row, data, start, end, display ) {
        ...
        $( api.column( 8 ).footer() ).html(
            pageTotal8.toLocaleString(undefined, {minimumFractionDigits: 2}) +'<br>'+
            ''+ total8.toLocaleString(undefined, {minimumFractionDigits: 2}) +''
        );
        $( api.column( 7 ).footer() ).html(
            pageTotal7.toLocaleString(undefined, {minimumFractionDigits: 2}) +'<br>'+
