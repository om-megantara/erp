...
<style type="text/css"> 
  #dt_list > tbody > tr > td , #dt_list > thead > tr > th { word-break: break-all; white-space: nowrap; }
          ...
          <form role="form" action="<?php echo current_url();?>" method="post" >
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <span class="left2">
                    <input type="text" class="form-control input-sm" autocomplete="off" name="mutationid" id="mutationid">
                  </span>
                </div>
              </div>
              <div class="col-md-6">
          ...
          <tbody>
            ...
            ?>
                  <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" data-toggle="modal" data-target="#modal-detail" ApprovalID="<?php echo $list['ApprovalID']; ?>"><i class="fa fa-fw fa-search"></i></button>
                      </td>
                  </tr>
            <?php } } ?>
          </tbody>
