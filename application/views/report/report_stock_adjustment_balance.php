    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Detail History Stock Check</h4>
        </div>
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">SAB</th>
              <th class=" alignCenter">Stock</th>
              <th class=" alignCenter">Last Checked</th>
              <th class=" alignCenter">Last Adjusted</th>
          ...
          <?php
            ...
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td class="alignleft note"><?php echo $list['ProductName'];?></td>
                  <td class=" alignCenter"><?php echo $list['ProductManager'];?></td>
                  <td class=" alignCenter"><?php echo $list['Shop'];?></td>
                  <td class=" alignCenter"><?php echo $list['SourceAgent'];?></td>
                  <?php if ($list['forSale']==1){
                    $forSale="Yes";
                  }else{
                    $forSale="No";
                  }?>
                  <td class=" alignCenter"><?php echo $forSale;?></td>
                  <td class="alignCenter"><a class="view_detail klik" type="button" product="<?php echo $list['ProductID'];?>" data-toggle="modal" data-target="#modal-detail"><?php echo $list['Sab'];?></a></td>
                  <td class="alignCenter"><?php echo $list['Quantity'];?></td>
                  <td class="alignCenter"><?php echo $list['LastCheck']." (".$list['DCheck'].")";?></td>
                  <td class="alignCenter"><?php echo $list['LastAdjust']." (".$list['DAdjust'].")";?></td>
                </tr>
          <?php } } ?>
          </tbody>
        </table>
...
jQuery( document ).ready(function( $ ) {
  ...
  function get(id) {
    ...
    var url="<?php echo base_url();?>report/get_report_stock_adjustment_detail"
    url=url+"?a="+id
