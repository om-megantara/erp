  ...
  <section class="content">
    <div class="box box-solid">
      <div class="box-body">
        ...
        <span>|| formula SlowMoving = Stock > ( rata2 3 bulan * <?php echo $main['SlowMovingMply'] ; ?> ) </span>
        ...
        <div id="divhideshow" style="border: 1px solid #0073b7; padding: 5px;">
            ...
            <button class="toggle-vis btn btn-primary btn-xs" title="PRICE" data-column="5">Price</button>
            <button class="toggle-vis btn btn-primary btn-xs" title="CATEGORY" data-column="6">Category</button>
            <button class="toggle-vis btn btn-primary btn-xs" title="BRAND" data-column="7">Brand</button>
            <button class="toggle-vis btn btn-primary btn-xs" title="DO-SO" data-column="12">DO-SO 3 month</button>
            <button class="toggle-vis btn btn-primary btn-xs" title="AVERAGE" data-column="13">Average</button>
        </div>
        <div id="divsearch">
        ...
        <table id="dt_list" class="table table-bordered table-hover nowrap" width="100%">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">Days <br>To LO</th>
              <th class=" alignCenter">DO-SO<br>3 MTH</th>
              <th class=" alignCenter">Sales<br>Per MTH</th>
              <th class=" alignCenter">STK <br>MTH Left</th>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Product Shop Detail </h4>
        </div>
        <div class="modal-body">
...
j11( document ).ready(function( $ ) {
  ...
  .DataTable({
    ...
    "serverSide": true, 
    "ajax": {
      "url": "<?php echo site_url('report/report_product_slowmoving_data')?>",
      "type": "POST",
      beforeSend: function(){
...
function get(product) {
  xmlHttp=GetXmlHttpObject()
    ...
    url=url+"?product="+product+"&ShowPriceList=yes&ShowShop=yes"
