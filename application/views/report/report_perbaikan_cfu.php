  ...
  <section class="content">
    ...
    <div class="box box-solid">
      <div class="box-header">
        <a title="ADD SALES ORDER" href="<?php echo base_url();?>report/cfu_add" id="add_sales_order" class="btn btn-primary btn-xs add_sales_order"><b>+</b> Add CFU</a>
            ...
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td class=" alignCenter">
                    <button type="submit" class="btn btn-primary btn-xs" onclick="window.open('<?php echo base_url();?>report/cfu_add', '_blank');"><i class="fa fa-fw fa-print"></i> Lihat CFU</button>
                  </td>
                </tr>
          <?php } } ?>
          </tbody>
