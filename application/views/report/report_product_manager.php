          ...
          <?php
            ...
            if (isset($content['main']['product'])) {
                ...
                <tr>
                  ...
                  <td class="alignleft"><a class="view_detail klik" type="button" product="<?php echo $list['ProductID'];?>" data-toggle="modal" data-target="#modal-detail"><?php echo wordwrap($list['ProductName'],75,"<br>\n");?></a></td>
                  <td class="alignleft"><?php echo wordwrap($list['ProductCategoryName'],35,"<br>\n");?></td>
