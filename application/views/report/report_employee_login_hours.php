		          ...
		          <tbody>
		            ...
		            ?>
		                  <tr>
		                      ...
		                      <td class="alignRight"><?php echo number_format($list['LoginMinute']);?></td>
		                      <td>
                				<button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" id="<?php echo $list['EmployeeID']; ?>" datestart="<?php echo $list['datestart']; ?>" dateend="<?php echo $list['dateend']; ?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button>
		                      </td>
		                  </tr>
		            <?php } } ?>
		          </tbody> 
...
j8( document ).ready(function( $ ) {
  ...
  $('#dt_list').resize(cek_dt);
	...
	function get(id, datestart, dateend) {
		...
		var url="<?php echo base_url();?>report/report_employee_login_hours_detail"
