          ...
          <form role="form" action="<?php echo current_url();?>" method="post" >
            <div class="col-md-6">
              <div class="form-group ">
                ...
                <span class="left2">
                  <div class="input-group input-group-sm form-addProduct">
                      <input type="text" class="form-control input-sm ProductID" name="ProductID[]" required="">
                      <span class="input-group-btn">
                        <button type="button" class="btn btn-primary addProductID" onclick="addProductID();">+</button>
                        <button type="button" class="btn btn-danger add_field" onclick="if ($('.form-addProduct').length != 1) { $(this).closest('.form-addProduct').remove();}">-</button>
                      </span>
                  </div>
                </span>
              </div>
          ...
          <?php
            ...
            if (isset($content['main']['main'])) {
                ...
                <tr>
                  ...
                  <td class="alignleft"><?php echo $content['brand'][ $list['ProductBrandID'] ]['ProductBrandName'];?></td>
                  <td class="alignRight"><?php echo number_format($list['Total'],2);?></td>
                  <td>
                    ...
                    <button type="button" class="btn btn-success btn-xs detailMonth" title="DETAIL MONTH" id="<?php echo $list['ProductID']; ?>" datestart="<?php echo $list['INVDateStart']; ?>" dateend="<?php echo $list['INVDateEnd']; ?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button>
                  </td>
                </tr>
          <?php } } ?>
          </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  function get2(id, date) {
    document.getElementById("detailcontent").innerHTML='<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span> '
    xmlHttp=GetXmlHttpObject()
    var url="<?php echo base_url();?>report/report_inv_product_detail_month"
    url=url+"?id="+id+"&datestart="+datestart+"&dateend="+dateend
    // alert(url);
    xmlHttp.onreadystatechange=stateChanged
    xmlHttp.open("GET",url,true)
...
function addProductID() {
  $(".form-addProduct:last").clone().insertAfter(".form-addProduct:last");
}
</script>