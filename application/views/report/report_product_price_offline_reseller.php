...
$brand = $content['brand'];
$pricelist = $content['main']['pricelist'];
$pricecategory = $content['main']['pricecategory'];
          ...
          <form role="form" action="<?php echo current_url();?>" method="post" >
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <span class="left2">
                  <select class="form-control input-sm" style="width: 100%;" name="expiry" id="expiry">
                      <option value="">All</option>
                      <option value="Not">Not Null</option>
                  </select>
                </span>
              </div>
              <div class="form-group">
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">Expiry</th>
              <th class=" alignCenter">Price End User</th>
              <th class=" alignCenter">Price Reseller</th>
            </tr>
          </thead>
          <tbody>
          <?php
            if (isset($content['main']['product'])) {
                ...
                <tr>
                  ...
                  <td class="alignleft"><a class="view_detail klik" type="button" product="<?php echo $list['ProductID'];?>" data-toggle="modal" data-target="#modal-detail"><?php echo wordwrap($list['ProductName'],65,"<br>\n");?></a></td>
                  <td class="alignleft"><?php echo wordwrap($list['ProductCategoryName'],50,"<br>\n");?></td>
                  ...
                  <td class=" alignCenter"><?php echo number_format($list['ResellerPrice'],0);?></td>
                </tr>
          <?php } } ?>
          </tbody>
        </table>
