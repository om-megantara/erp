  ...
  <section class="content">
    ...
    <div class="box box-solid">
      <div class="box-header with-border">
        ...
        <div id="divhideshow">
          Hide/Show Column :
          <a class="btn btn-primary btn-xs toggle-vis" data-column="4">Note</a>
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          ...
          ?>
                <tr>
                  ...
                  <td class="alignRight"><?php echo $list['late_days'];?></td>
                  <td class="alignRight <?php echo $stockReady;?>"><?php echo $stockReady;?></td>
                  ...
                  <td class="alignRight"><?php echo $list['outstanding_payment'];?></td>
                  <td class="alignRight"><?php echo $list['qty'];?></td>
                  <td class="alignRight"><?php echo $list['totaldo'];?></td>
                  <td class="alignRight"><?php echo $list['outstanding_do'];?></td>
                  <td>
