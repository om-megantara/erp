...
<style type="text/css"> 
  ...
  @media (min-width: 768px){
      ...
      .box-header > button, .box-header > a { margin-top: -20px; }
  }
  ...
  <section class="content">
    <div class="box box-solid">
      <div class="box-header with-border">
        ...
        <div class="form_print_dor" style="display: inline-grid;">
          <div class="input-group input-group-sm">
            <div class="input-group-btn">
              <button type="button" class="btn btn-primary btn-xs printdor2">Print</button>
            </div>
            <input type="text" class="form-control input-sm" id="dorid2" name="dorid2" placeholder="INSERT DOR ID" autocomplete="off">
          </div>
        </div>
          ...
          <form role="form" action="<?php echo current_url();?>" method="post" >
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <span class="left2">
                    <select class="form-control input-sm" style="width: 100%;" name="distribution" required="">
                      <option value="NotInDIstribution"> Not In DIstribution</option>
                      <option value="InDIstribution"> In Distribution</option>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-addon">
                      ...
                      <input type="text" class="form-control input-sm" autocomplete="off" name="input1" id="input1" required="">
                  </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control input-sm" autocomplete="off" name="input2" id="input2" required="">
                    </div>
                </div>
              </div>
              <div class="col-md-12">
...
jQuery( document ).ready(function( $ ) {
  ...
  $(".printdor2").live('click', function() {
    dor = $(this).parent().parent().find("#dorid2").val()
    openPopupOneAtATime3(dor);
  });
