          ...
          <form role="form" action="<?php echo current_url();?>" method="post" >
              <div class="col-md-6" >
                <div class="form-group">
                  ...
                  <span class="left2">
                    <input type="text" class="form-control input-sm" autocomplete="off" name="pricelistid" id="pricelistid">
                  </span>
                </div>
              </div>
              <div class="col-md-6">
          ...
          <tbody>
            ...
            ?>
                  <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" data-toggle="modal" data-target="#modal-detail" ApprovalID="<?php echo $list['ApprovalID']; ?>" PricelistID="<?php echo $list['PricelistID']; ?>"><i class="fa fa-fw fa-search"></i></button>
                      </td>
                  </tr>
            <?php } } ?>
          </tbody>
...
function get(id) {
  xmlHttp=GetXmlHttpObject()
    var url="<?php echo base_url();?>report/report_approval_price_list_detail"
    url=url+"?ApprovalID="+id
