    ...
    <div class="box box-solid">
      <div class="box-header">
        ...
        <div id="divhideshow">
          ...
          <a class="btn btn-xs toggle-vis btn btn-primary btn-xs" data-column="8">Shop Count</a>
        </div>
      </div>
      <div class="box-body">
        <table id="dt_list" class="table table-bordered">
          <thead>
            <tr>
              ...
              <th class="alignCenter">Total Rp</th>
          ...
          <?php
            ...
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td class="alignRight"><?php echo $list['TotalSO'];?></td>
                  ...
                  <td>
                    <button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" datestart="<?php echo $list['SODateStartSub']; ?>" dateend="<?php echo $list['SODateEndSub']; ?>" id="<?php echo $list['ShopID']; ?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button>
                  </td>
...
jQuery( document ).ready(function( $ ) {
  ...
  function get(id, datestart, dateend) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>report/report_so_shop_detail"
  ...
  function get2(id, datestart, dateend) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>report/report_so_shop_detail_month"
      url=url+"?id="+id+"&datestart="+datestart+"&dateend="+dateend
      document.getElementById("detailcontent").innerHTML='<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span>'
      // alert(url);
      xmlHttp.onreadystatechange=stateChanged
