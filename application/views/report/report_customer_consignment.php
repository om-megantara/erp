    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
          <div class="modal-header">
              ...
              <h4 class="modal-title">CUSTOMER (CONSIGNMENT) LIST</h4>
          </div>
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">Customer With Consignment</th>
              <th class=" alignCenter">SO Consignment</th>
              <th class=" alignCenter">Qty Consignment</th>
              <th class=" alignCenter">Qty DO Consignment</th>
          ...
          $urut=1;
            if (isset($content)) {
                ...
                <tr>
                  ...
                  <td class="alignRight"><?php echo number_format($list['ProductQtyDO']);?></td>
                  ...
                  <td class="alignRight">
                    <button type="button" class="btn btn-primary btn-xs detailcon" title="DETAIL DO CONSIGNMENT" city="<?php echo $list['CityID'];?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button>
                  </td>
                </tr>
          <?php $urut++;} } ?>
          </tbody>
...
jQuery( document ).ready(function( $ ) { 
  ...
  $('.detailcon').live('click', function(e){
        city  = $(this).attr("city")
        get(city);
  });  
  ...
  function get(city) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>report/report_customer_consignment_detail"
      url=url+"?city="+city
