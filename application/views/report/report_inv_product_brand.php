        ...
        <div class="modal-body">
          <div class="row rowtext"> 
              <div class="input-group input-group-sm">                
                <input type="hidden" class="form-control input-sm BrandID" name="BrandID[]" required="" readonly="">
                <input type="text" class="form-control input-sm BrandName" name="BrandName[]" required="" readonly="">
          ...
          <form role="form" action="<?php echo current_url();?>" method="post" >
            <div class="col-md-6">
              <div class="form-group">
                ...
                <span class="left2">
                  <div class="input-group input-group-sm">
                      <select class="form-control input-sm BrandList select2" style="width: 100%;" name="BrandList" required="">
              ...
              <div class="form-group BrandListInput"></div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
...
function createList() {
  ...
  $(".rowtext:first .BrandID").val(BrandID);
  $(".rowtext:first .BrandName").val(BrandName);
  $(".rowtext:first").clone().appendTo('.BrandListInput'); 
}
...
window.onload = function () {
  var chart = new CanvasJS.Chart("chartContainer", {
    ...
    subtitles: [{
      text: "Click Brand to Hide or Unhide Data Series"
    }], 
    axisX: {
      title: "Months"
    },
    ...
    data: [
      <?php if (isset($main)) { ?>
        <?php foreach ($main as $row => $list) { ?>
          {
            type: "column",
            name: "<?php echo $list['BrandName'];?>",
            showInLegend: true,      
            yValueFormatString: "#,##0.# pcs",
            dataPoints: [
              <?php if (isset($detail[$list['BrandID']])) { ?>
                <?php foreach ($detail[$list['BrandID']] as $row => $list) { ?>
