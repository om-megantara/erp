        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">HPP Price </th>
          ...
          <?php
            ...
            if (isset($content['main']['product'])) {
                ...
                <tr>
                  ...
                  <td class=" alignCenter"><?php echo number_format($list['ProductPriceHPP'],0);?></td>
                  <td><button type="button" class="btn btn-primary btn-xs" onclick="window.open('<?php echo base_url();?>master/product_add?id=<?php echo $list['ProductID']; ?>', '_blank');" title="EDIT"><i class="fa fa-fw fa-edit"></i></button></td>
                </tr>
          <?php } } ?>
          </tbody>
        </table>
