    ...
    <div class="box box-solid">
      <div class="box-body">
        ...
        <div id="divhideshow" style="border: 1px solid #0073b7; padding: 5px;">
            Hide/Show Column :
            <button class="toggle-vis btn btn-primary btn-xs" data-column="1">Name</button>
            <button class="toggle-vis btn btn-primary btn-xs" data-column="2">Code</button>
            <button class="toggle-vis btn btn-primary btn-xs" data-column="6">Shop Assigned</button>
            <button class="toggle-vis btn btn-primary btn-xs" data-column="7">Link Updated</button>
        ...
        <table id="dt_list" class="table table-bordered table-hover nowrap" width="100%">
          <thead>
            <tr>
              ...
              <th class="alignCenter">PShop</th>
              <th class="alignCenter">Source<br>Agent</th>
              <th class="alignCenter">IShop<br>Assigned</th>
              <th class="alignCenter">Link<br>Updated</th>
...
j11( document ).ready(function( $ ) {
  ...
  .DataTable({
    ...
    // },
    "columnDefs": [ 
      {"targets": 0, "width": "1%", className: "alignCenter"},
      {"targets": 3, "width": "1%", className: "alignCenter"},
      {"targets": 4, "width": "1%", className: "alignCenter"},
      {"targets": 5, "width": "1%", className: "alignCenter"},
    ],
    "order": [[1,"asc"]],
    "searchDelay": 1000,
    "processing": true, 
    ...
    "serverSide": true, 
    "ajax": {
      "url": "<?php echo site_url('report/report_product_shop_data')?>",
      "type": "POST",
      beforeSend: function(){
...
$('.shop').live('click', function(e){
  // alert($(this).attr("productid"));
  productid=$(this).attr('productid');
  // $(".shopproduct"+productid).text(productid);
  get2(productid);
});
function get2(productid){
  xmlHttp=GetXmlHttpObject()
    var url="<?php echo base_url();?>report/product_shop_detail"
...
function stateChanged2(){
    if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){
        $(".shopproduct"+productid).html(xmlHttp.responseText);
