    ...
    <div class="box box-solid">
      <div class="box-header">
        ...
        <div id="divhideshow" style="border: 1px solid #0073b7;">
          ...
          <a class="btn btn-primary btn-xs toggle-vis" title="NAME" data-column="13">Description</a>
        </div>
        <div id="divsearch">
        ...
        <table id="dt_list" class="table table-bordered nowrap table-hover" width="100%">
          <thead>
            <tr>
              ...
              <th>Min</th>
              <th>Max</th>
              <th>Min-RO<br>Suggestion</th>
              <th>Max-RO<br>Suggestion</th>
              <th>Stock<br>All</th>
              <th>SO<br>Pending</th>
...
j11( document ).ready(function( $ ) {
  ...
  .DataTable({
    ...
    "ajax": {
      "url": "<?php echo site_url('report/report_product_stock_ready_ro_data')?>",
      "type": "POST",
      beforeSend: function(){
