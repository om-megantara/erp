...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-solid">
      <div class="box-body">
        <button type="button" class="btn btn-primary btn-xs print_dt" title="PRINT" removeTd="1"><i class="fa fa-print"></i> Print</button>
        <button class="btn btn-primary btn-xs" id="hideshow" class="hideshow" title="HIDE/SHOW COLUMN">Hide/Show Column</button>
        <button class="btn btn-primary btn-xs" id="searchProduct" title="SEARCH PRODUCT"><i class="fa fa-search"></i> Filter</button>
        ...
        <div id="divhideshow" style="border: 1px solid #0073b7; padding: 5px;">
            ...
            <button class="toggle-vis btn btn-primary btn-xs" data-column="7">PriceList</button>
