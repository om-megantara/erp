          ...
          <form role="form" action="<?php echo current_url();?>" method="post" >
              <div class="col-md-6">
                <div class="form-group">
                  <label class="left">Adjustment ID</label>
                  <span class="left2">
                    <input type="text" class="form-control input-sm" autocomplete="off" name="adjustmentid" id="adjustmentid">
                  </span>
                </div>
              </div>
              <div class="col-md-6">
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100%;">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">Adjustment ID</th>
            ...
            <?php
              if (isset($content)) {
                  foreach ($content as $row => $list) { 
                    $Title = str_replace("//", "<br>", $list['Title'])
            ?>
                  <tr>
                      <td class=" alignCenter"><?php echo $list['ApprovalID'];?></td>
                      <td class=" alignCenter"><?php echo $list['AdjustmentID'];?></td>
