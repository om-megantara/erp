          ...
          <?php
            ...
            if (isset($content['main'])) {
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-primary btn-xs detail" title="DETAIL" id="<?php echo $list['SalesID']; ?>" datestart="<?php echo $list['INVDateStart']; ?>" dateend="<?php echo $list['INVDateEnd']; ?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button>
                    <!-- <button type="button" class="btn btn-success btn-xs detailmonth" title="DETAIL BY MONTH" id="<?php echo $list['SalesID']; ?>" datestart="<?php echo $list['INVDateStart']; ?>" dateend="<?php echo $list['INVDateEnd']; ?>" data-toggle="modal" data-target="#modal-detail"><i class="fa fa-fw fa-search"></i></button> -->
                  </td>
...
jQuery( document ).ready(function( $ ) {
  ...
  function get(id, datestart, dateend) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>report/report_inv_sales_detail"
  ...
  function get2(id, datestart, dateend) {
    xmlHttp=GetXmlHttpObject()
      var url="<?php echo base_url();?>report/report_inv_sales_detail_month"
      url=url+"?id="+id+"&datestart="+datestart+"&dateend="+dateend
      document.getElementById("detailcontent").innerHTML='<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span>'
      // alert(url);
      xmlHttp.onreadystatechange=stateChanged
