  ...
  <section class="content">
    <div class="box box-solid">
      <div class="box-header">
        <a href="#" id="filterdate" class="filterdate"><i class="fa fa-search"></i> Filter</a>
        ...
        <div>
          <h3 class="box-title"> Total DP : Rp. <?php echo number_format($content['DP'],2); ?></h3><br>
          <h3 class="box-title"> Total Pelunasan : Rp. <?php echo number_format($content['P'],2); ?></h3>
        </div>     
      </div>
        ...
        <table id="dt_list" class="table table-bordered " style="width: 100% !important;">
          ...
          <?php
            if (isset($content['main'])) {
                ...
                <tr>
                  <td><?php echo $list['DepositID'];?></td>
                  <td><?php echo $list['Company2'];?></td>
                  <td><?php echo number_format($list['DepositAmount'],2);?></td>
