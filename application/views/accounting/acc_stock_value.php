  ...
  <section class="content">
    <div class="box box-solid">
      <div class="box-header">
        ...
        <div class="summary">
          Value of Inventory : Rp. <?php echo number_format($summary,2);?>
        </div>
        
        <div id="divhideshow" style="border: 1px solid #0073b7; padding: 5px;">
            Hide/Show Column :
            <button class="toggle-vis btn btn-primary btn-xs" title="Product Name" data-column="1">Product Name</button>
            <button class="toggle-vis btn btn-primary btn-xs" title="Product Code" data-column="2">Product Code</button>
            <button class="toggle-vis btn btn-primary btn-xs" title="Stock" data-column="3">Stock</button>
            <button class="toggle-vis btn btn-primary btn-xs" title="HPP" data-column="4">HPP</button>
        </div>
        ...
        <table id="dt_list" class="table table-bordered table-hover nowrap" width="100%">
          <thead>
            <tr>
              ...
              <th class=" alignCenter">Total Value</th>
...
j11( document ).ready(function( $ ) {
  ...
  .DataTable({
    ...
    "columnDefs": [ 
      {"targets": 1, "width": "1%"},
      {"targets": 2, "width": "1%"},
      {"targets": 3, "width": "1%", "sClass": "alignRight"},
      {"targets": 4, "width": "1%", "sClass": "alignRight"},
      {"targets": 5, "width": "1%", "sClass": "alignRight"},
    ],
    "order": [[0,"asc"]],
    "searchDelay": 1000,
    "processing": true, 
    ...
    "serverSide": true, 
    "ajax": {
      "url": "<?php echo site_url('accounting/acc_stock_value_data')?>",
      "type": "POST",
      beforeSend: function(){
      ...
      "data": function ( data, settings ) {
          ...
          data.stockAll = $("input[name='stock']:checked").val();
