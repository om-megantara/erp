                      ...
                      if (isset($content['close'])) {
                          foreach ($content['close'] as $row => $list) {?>
							  <tr>
								...
								<td><?php echo $list['LevelCcName']."-".$list['LevelCcName2'];?></td>
								<td><a href="#" id="view" class="dtbutton" style="margin: 0px;" data-toggle="modal" data-target="#modal-contact"><i class="fa fa-fw fa-eye"></i>
								</a>&nbsp;<a href="<?php echo base_url();?>hrd/task_cu/<?php echo $list['TaskID'];?>" id="edit" class="edit" style="margin: 0px;" target="_blank" title="EDIT"><i class="fa fa-fw fa-edit"></i></a>&nbsp;<a href="<?php echo base_url();?>hrd/task_list_comment/<?php echo $list['TaskID'];?>" id="edit" class="edit" style="margin: 0px; display: <?php echo $list['DisplayEdit']; ?>" target="_blank" title="COMMENT"><i class="fa fa-fw fa-edit"></i></a></td>
							  </tr>
                    <?php } } ?>
                  </tbody>
                </table>
