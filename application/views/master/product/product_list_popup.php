    ...
    <div class="box box-solid">
      <div class="box-header">
        ...
        <div id="divhideshow">
          ...
          <a class="btn btn-primary btn-xs toggle-vis" data-column="8" title="">Stock</a>
...
j11( document ).ready(function( $ ) {
  ...
  .DataTable({
    ...
    "serverSide": true, 
    "ajax": {
      "url": "<?php echo site_url('general/product_list_popup_data')?>",
      "type": "POST",
      beforeSend: function(){
  ...
  $('#check').on('click', function(e){
    ...
    $.each(rows_selected, function(index, rowId){
      ...
      if (index <= (rows_selected.length)) {
        ...
        valueCurrent.tdcode = table.cell( rowId, 4 ).data();
        valueCurrent.tdname = table.cell( rowId, 3 ).data();
        valueCurrent.tdprice = table.cell( rowId, 5 ).data();
