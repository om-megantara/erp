    ...
    <div class="box box-solid">
      <div class="box-header">
        ...
        <div id="divhideshow">
          ...
          <a class="btn btn-primary btn-xs toggle-vis" data-column="5" title="">Price</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="6" title="">Category</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="7" title="">Brand</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="8" title="">Quality</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="9" title="">Description</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="10" title="">Status</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="11" title="">Last Checked</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="12" style="display:none;" title="">Block</a>
        </div>
...
j11( document ).ready(function( $ ) {
  ...
  .DataTable({
    ...
    "serverSide": true, 
    "ajax": {
      "url": "<?php echo site_url('general/product_list_popup_warehouse_data_check')?>",
      "type": "POST",
      beforeSend: function(){
  ...
  $('#check').on('click', function(e){
    ...
    $.each(rows_selected, function(index, rowId){
      rowId = rowId - 1
      block = table.cell( rowId, 11 ).data();
      if(block==1){
        alert("Product ID on Progress to Approval")
      } else {
        if (index <= (rows_selected.length)) {
          ...
          // valueCurrent.block = table.cell( rowId, 5 ).data();
