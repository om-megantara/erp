    ...
    <div class="box box-solid">
      <div class="box-header">
        ...
        <div id="divhideshow" style="border: 1px solid #0073b7;">
          ...
          <a class="btn btn-primary btn-xs toggle-vis" data-column="6">Price</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="7">Category</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="8">Brand</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="9">Stock</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="10">CodeBar</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="11">Atribute</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="12">Status</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="13">Category Full</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="14">Brand Full</a>
          <a class="btn btn-primary btn-xs toggle-vis" data-column="15">ModifiedDate</a>
        </div>
        <div id="divsearch">
...
j11( document ).ready(function( $ ) {
  ...
  .DataTable({
    ...
    "serverSide": true, 
    "ajax": {
      "url": "<?php echo site_url('master/product_hpp_list_data')?>",
      "type": "POST",
      beforeSend: function(){
