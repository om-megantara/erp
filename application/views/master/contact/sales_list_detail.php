      ...
      <div class="box-body">
        <ul class="list-group list-group-unbordered">
          <li class="list-group-item view-partner">
            <b>Edit Sales</b> 
            <button type="button" class="btn btn-primary btn-xs pull-right" title="EDIT SALES" onclick="window.open('<?php echo base_url();?>master/sales_cu/<?php echo $content['id'];?>', '_blank');">Edit</button>
          </li> 
        </ul>
      </div>
    </div>
