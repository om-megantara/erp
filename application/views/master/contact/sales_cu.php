  ...
  <section class="content">
    ...
    <div class="box box-solid">
      ...
      <div class="box-body form_addcontact">
          <form name="form sales_add" id="form sales_add" action="<?php echo base_url();?>master/sales_cu_act" method="post" enctype="multipart/form-data" autocomplete="off" onSubmit="return cek_input_detail()">
            <input type="hidden" name="contactid" value="<?php echo $content['personal']['ContactID'];?>">
            <input type="hidden" name="salesid" value="<?php echo $content['personal']['SalesID'];?>">
            <div class="col-md-6">
              <div class="box box-solid">
                <div class="box-header with-border">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <span class="left2">
                        <select class="form-control input-sm sec" name="sec" required="">
                          <option value='<?php echo $content['personal']['salesParent'];?>' selected><?php echo $content['personal']['secname'];?></option>
                        </select>
                    </span> 
                  </div>
                  <div class="form-group">
...
j8( document ).ready(function( $ ) {
  ...
  $('#status option[value=<?php echo $content['personal']['isActive'];?>]').attr('selected','selected');
  ...
  $('.sec option[value=<?php echo $content['personal']['SalesParent'];?>]').attr('selected','selected');
  j8('.contactp').select2({
  ...
  $.ajax({
      ...
      success:function(response){
        ...
        for( var i = 0; i<len; i++){
            ...
            $(".sec").append("<option value='"+SalesID+"'>"+SalesName+"</option>");
        }
      }
  });
}
