...
<style type="text/css">
  ...
  .phone, .email, .cperson input, .cperson textarea { margin-top: 2px; }
  ...
  <section class="content">
    ...
    <div class="box box-solid">
      ...
      <div class="box-body form_addcontact">
          <form name="form employee_add" id="form employee_add" action="<?php echo base_url();?>master/supplier_cu_act" method="post" enctype="multipart/form-data" autocomplete="off" onSubmit="return cek_input_detail()">
            <input type="hidden" name="contactid" value="<?php echo $content['personal']['ContactID'];?>">
            <input type="hidden" name="supplierid" value="<?php echo $content['personal']['SupplierID'];?>">
            <div class="col-md-6">
              <div class="box box-solid">
                <div class="box-header with-border">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <label class="left">Payment Term Day</label>
                    <span class="left2">
                      <input type="number" class="form-control input-sm" id="payment" name="payment" autocomplete="off" value="<?php echo $content['personal']['SupplierPayTerm'];?>" required>
                    </span>
                  </div>
                  <div class="form-group">
                    <label class="left">Shipping Term Day</label>
                    <span class="left2">
                      <input type="number" class="form-control input-sm" id="shipping" name="shipping" autocomplete="off" value="<?php echo $content['personal']['SupplierShipTerm'];?>" required>
                    </span>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    foreach ($content['phone'] as $row => $listphone) {?>
                      <div class="input-group input-group-sm phone">
                        <input type="text" class="form-control input-sm" name="phone[]" placeholder="Ex: 08xxxx" value='<?php echo $listphone['DetailValue'];?>'>
                  ...
                  <div style="max-height: 1200px; overflow-y: auto;">
                    <?php foreach ($content['alamat'] as $row => $list) { ?>
                      <div class="form-group address">
                        ...
                        <a href="#" onclick="duplicateaddr();" class="add_addr">+</a>
                        <a href="#" onclick="if ($('.address').length != 1) { $(this).closest('div').remove();}" class="add_addr">-</a>
...
j8( document ).ready(function( $ ) {
  ...
  $("li.<?php echo $menu;?>").addClass("active").parents("li").addClass("active");
