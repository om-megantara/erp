      ...
      <div class="box-body box-profile">
        ...
        <ul class="list-group list-group-unbordered">
          ...
          <li class="list-group-item view-partner">
            ...
            <button type="button" class="btn btn-primary btn-xs pull-right" title="VIEW" onclick="window.open('<?php echo base_url();?>master/customer_cu/<?php echo $content['ContactID'];?>', '_blank');">View</button>
          </li>
          <?php } else { ?>
          <li class="list-group-item view-partner">
            <b>Set as Customer</b> 
          ...
          <li class="list-group-item view-partner">
            ...
            <button type="button" class="btn btn-primary btn-xs pull-right" title="VIEW" onclick="window.open('<?php echo base_url();?>master/supplier_cu/<?php echo $content['ContactID'];?>', '_blank');">View</button>
          </li>
          <?php } else { ?>
          <li class="list-group-item view-partner">
            <b>Set as Supplier</b> 
          ...
          <li class="list-group-item view-partner">
            ...
            <button type="button" class="btn btn-primary btn-xs pull-right" title="VIEW" onclick="window.open('<?php echo base_url();?>master/expedition_cu/<?php echo $content['id'];?>', '_blank');">View</button>
          </li>
          <?php } else { ?>
          <li class="list-group-item view-partner">
          ...
          <li class="list-group-item view-partner">
            <b>View in Sales</b> 
            <button type="button" class="btn btn-primary btn-xs pull-right" title="VIEW" onclick="window.open('<?php echo base_url();?>master/sales_cu/<?php echo $content['id'];?>', '_blank');">View</button>
          </li>
          <?php } else { ?>
          <li class="list-group-item view-partner">
            <b>Set as Sales</b> 
