  ...
  <section class="content">
    ...
    <div class="box box-solid">
      ...
      <div class="box-body form_addcontact">
          <form name="form expedition_add" id="form expedition_add" action="<?php echo base_url();?>master/expedition_cu_act" method="post" enctype="multipart/form-data" autocomplete="off" onSubmit="return cek_input_detail()">
            <input type="hidden" name="contactid" value="<?php echo $content['personal']['ContactID'];?>">
            <input type="hidden" name="expeditionid" value="<?php echo $content['personal']['ExpeditionID'];?>">
            <div class="col-md-6">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <div class="form-group">
                    ...
                    foreach ($content['email'] as $row => $listemail) {?>
                      <div class="input-group input-group-sm email">
                        <input type="text" class="form-control input-sm" name="email[]" placeholder="example@gmail.com" value='<?php echo $listemail['DetailValue'];?>' required="">
                          <span class="input-group-btn input-group-title">
