  ...
  <section class="content">
    <div class="box box-solid">
      <div class="box-body form_add">
        <form name="form" id="form" action="<?php echo base_url();?>master/city_cu_act" method="post" enctype="multipart/form-data" autocomplete="off">
          <div class="col-md-6">
            <div class="box box-solid">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <span class="left2">
                    <input type="text" class="form-control input-sm" placeholder="City Name" autocomplete="off" name="cityname" id="cityname" required="">
                  </span>
                </div>
                <div class="form-group">
            ...
            <div class="box box-solid">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <span class="left2">
                    <select class="form-control input-sm select2" style="width: 100%;" name="expedition" id="expedition">
                      <?php foreach ($expedition['main'] as $row => $list) { ?>
                ...
                <div class="form-group">
                  <label class="left">Price (perKG)</label>
                  <span class="left2">
                    <input type="text" class="form-control input-sm" placeholder="Price (perKG)" autocomplete="off" name="price" id="price" required="">
                  </span>
                </div>
                <div class="form-group">
                  <label class="left">Minimum Weight(KG)</label>
                  <span class="left2">
                    <input type="text" class="form-control input-sm" placeholder="Minimum Weight(KG)" autocomplete="off" name="weight" id="weight" required="">
                  </span>
                </div>
              </div>
            </div>
...
j8( document ).ready(function( $ ) {
  ...
  if ($("#cityid").length != 0) {
    ...
    $("#form #price").val('<?php if ( isset($city_detail)){ echo $city_detail['FCPrice']; }?>');
    $("#form #weight").val('<?php if ( isset($city_detail)){ echo $city_detail['FCWeight']; }?>');
    $("#form #expedition").val('<?php if ( isset($city_detail)){ echo $city_detail['ExpeditionID']; }?>').trigger('change');
