  ...
  <section class="content">
    <div class="box box-solid">
      <div class="box-header with-border">
        <a title="ADD PRICE LIST" href="<?php echo base_url();?>master/price_list_cu/new" id="addEmployee" class="addEmployee btn btn-primary btn-sm" target="_blank" style="margin-top: -22px;" ><b>+</b> Add Price List</a>
        <div class="form_cek_used_code" style="display: inline-grid;">
          <div class="input-group input-group-sm">
            ...
            <input type="text" class="form-control input-sm" id="ProductID" name="ProductID" placeholder="Check Product ID in Pricelist" autocomplete="off">
          </div>
        </div>
      </div>
      <div class="box-body">
          <table id="dt_list" class="table table-bordered table-hover nowrap" width="100%">
            ...
            <tr>
              ...
              <th class=" alignCenter">Pricelist Name</th>
              <th class=" alignCenter">Price Category</th>
              <th class=" alignCenter">Count</th>
              <th class=" alignCenter">Pricelist End</th>
