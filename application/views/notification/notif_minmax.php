      ...
      <div class="box-body form_addcontact">
          <table id="dt_list" class="table table-bordered table-hover nowrap dtapproval" width="100%">
            ...
            <tr>
              ...
              <th class="alignCenter">MINMAX</th>
              <th class="alignCenter">Stock</th>
              <th class="alignCenter">ROS Max</th>
                  ...
                  foreach ($content['list'] as $row => $list) { $no++;?>
                      <tr>
                        ...
                        <td class="alignCenter">
                          <a class='view_detail' title='Detail' productid='<?php echo $list['NoteReff'];?>' data-toggle="modal" data-target="#modal-detail"><?php echo $list['NoteReff'];?></button>
                        </td>
                        <td class="detailNote"><?php echo $list['ProductName'];?></td>
                        <td class="alignLeft"><?php echo "MIN = ".number_format($list['MinStock']);?><br><?php echo "MAX = ".number_format($list['MaxStock']);?></td>
                        <td class="alignRight"><?php echo number_format($list['stock']);?></td>
                        <td class="alignRight"><?php echo number_format($list['ROS']);?></td>
                        <td class="alignRight"><?php echo number_format($list['popending']);?></td>
