...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-solid">
      <div class="box-body">
        <form name="form" id="form" action="<?php echo base_url();?>employee/employee_penalty_act" method="post" enctype="multipart/form-data" autocomplete="off">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <span class="left2">
                ...
                <input type="text" class="form-control input-sm name" name="name" required="" value="<?php echo $content[0]['fullname'];?>">
              </span>
            </div>
            <?php } ?>
            <div class="form-group">
              ...
              <span class="left2">
                <select class="form-control input-sm type" id="type" name="type" onchange="calculate(this)" required=""> 
                  <?php 
                    foreach ($content['penalty'] as $row => $list) { 
                  ?>
                  <option value="<?php echo $list['PenaltyID'];?>"><?php echo $list['PenaltyName']." (".$list['Note'].") ";?></option>
                  <?php } ?>
                </select>
              </span>
            </div>
...
function calculate(poin){
  var poin = poin.value;
  $.ajax({
    url: "<?php echo base_url();?>employee/get_poin",
    type : 'GET',
    data : 'poin=' +poin,
    dataType : 'json',
