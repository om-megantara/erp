          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-adddivision with-border">
                  <form role="form" action="<?php echo base_url();?>administration/group_add" method="post" >
                    <div class="box box-solid ">
                      ...
                      <div class="box-body">
                        <div class="form-group">
                          <label class="left">Group Name</label>
                          <span class="left2">
                            <input type="text" class="form-control input-sm" placeholder="Group Name" autocomplete="off" name="name" id="name">
                          </span>
                        </div>
                ...
                <div class="form-editdivision with-border">
                  <form role="form" action="<?php echo base_url();?>administration/group_edit" method="post" >
                    <div class="box box-solid ">
                      <div class="box-header">
                      ...
                      <div class="box-body">
                        <div class="form-group">
                          ...
                          <span class="left2">
                            <div class="row">
                              <div class="col-xs-6">
                                <input type="text" class="form-control input-sm" placeholder="Group Name" autocomplete="off" name="id" id="id2" readonly="">
                              </div>
                              <div class="col-xs-6">
                                <input type="text" class="form-control input-sm" placeholder="Group Name" autocomplete="off" name="name" id="name2">
                              </div>
                            </div>
                          </span>
                        </div>
  ...
  <section class="content">
    <div class="box box-solid">
      <div class="box-header with-border">
        ...
        <a href="#" id="adddivision" class="btn btn-primary btn-xs adddivision" data-toggle="modal" data-target="#scrollmodal"><b>+</b> Add Group</a><br>
      </div>
      ...
      <div class="box-body">
          <table id="dt_list" class="table table-bordered table-hover nowrap" width="100%">
            ...
            <tbody>
            <?php
              foreach ($content['group'] as $row => $list2) { ?>
                <tr>
                  <td><?php echo $list2['UsergroupID'];?></td>
                  <td><?php echo $list2['UsergroupNama'];?></td>
                  <td class="DTbreakWord"><?php echo $list2['UsergroupMenu'];?></td>
                  <td>
                    <button type="button" id="edit" class="btn btn-success btn-xs edit" title="EDIT" data-toggle="modal" data-target="#scrollmodal"><i class="fa fa-fw fa-edit"></i></button>
                  </td>
                </tr>
            <?php } ?>
            </tbody>
...
jQuery( document ).ready(function( $ ) {
  ...
  $('.edit').live('click',function(e){
    ...
    menu  = par.find("td:nth-child(3)").html();
    $("#id2").val(id);
    $("#name2").val(name);
    if (menu != "") {
      menu = menu.split(', ');
